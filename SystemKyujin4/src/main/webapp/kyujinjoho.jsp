    ...
    <div class="container_12">
        <div class="grid_9" style="border:0 solid red;width: 98%">
            ...
            <nav class="primary">
                <ul>
                    ...
                    <li>
                        <a id="a2" href="${pageContext.request.contextPath}/kyushokujoho.jsp">求職情報</a>
                    </li>
                    <li>
                        <a id="a3" href="javascript:location.reload();">求人情報</a>
                    </li>
                    <li>
        ...
        <form id="form1">
            <table class="jobCard_mainContent"  role="presentation">
                ...
                <tbody>
                <c:forEach items="${requestScope.kyujinlist}" var="list">
                    <tr>
                        <td>
                            <label>
                                <input type="checkbox" name="KSId" value="${list.KJId}" >
                            </label>
                        </td>
                        <td name="kaishaId">
                            <a href="${pageContext.request.contextPath}/kyujinList/detail?id=${list.KJId}">${list.kaishaId}</a>
                        </td>
